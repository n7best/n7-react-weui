...
describe('Button', function () {
  ...
  it('should have default weui_btn class', function () {
  ...
  it('should have primary weui_btn class', function () {
  ...
  it('should have primary disabled class', function () {
  ...
  it('should have mini class', function () {
  ...
  it('should have warn plain button class', function () {
  ...
  it('should have primary plain disabled class', function () {
  ...
  (0, _enzyme.describeWithDOM)('Button Event Check', function () {
